...
public class AliasIntegrationTest extends AbstractFullDistribZkTestBase {
  ...
  public void doTest() throws Exception {
    ...
    QueryResponse res = cloudClient.query(query, METHOD.GET, SEARCH_CREDENTIALS);
    ...
    res = server.query(query, METHOD.GET, SEARCH_CREDENTIALS);
    assertEquals(3, res.getResults().getNumFound());
    ...
    query = new SolrQuery("*:*");
    query.set("collection", "testalias");
    res = cloudSolrServer.query(query, METHOD.GET, SEARCH_CREDENTIALS);
    ...
    query = new SolrQuery("*:*");
    query.set("collection", "testalias");
    res = cloudClient.query(query, METHOD.GET, SEARCH_CREDENTIALS);
    ...
    res = client.query(query, METHOD.GET, SEARCH_CREDENTIALS);
    assertEquals(5, res.getResults().getNumFound());
